...
public class MyAccountSidebarPageUI {
    public static final String ADDRESSES_LINK_TEXT = "xpath=//div[@class='side-2']//a[text()='Addresses']";
    public static final String REWARD_LINK_TEXT = "xpath=//div[@class='side-2']//a[text()='Reward points']";
